<template>
  <div>
    <el-dialog v-model="modal" title="TẠO TÀI KHOẢN" width="500" align-center>
      <div>
        <div
        ...
        <div class="my-8">
          <el-divider> HOẶC ĐĂNG KÝ BẰNG </el-divider>
        </div>
...
useListen("show-register", () => {
  modal.value = true;
});

onBeforeUnmount(() => {
  removeListen("show-register");
});

async function on_regist() {
  showLoading();
